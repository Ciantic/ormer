...
export const ALL_VALIBOT_FIELDS = {
  ...
  c_int_pk:           { valibot: v.pipe(v.number(), d.int32(), d.primaryKey(), d.autoIncrement()),     example: 1 },
  ...
  c_int64_pk:         { valibot: v.pipe(v.bigint(), d.int64(), d.primaryKey(), d.autoIncrement()),     example: 1n },
